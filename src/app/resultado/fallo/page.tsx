    ...
    <main className="grid-pattern relative min-h-screen overflow-x-hidden bg-[var(--background)] text-white">
      ...
      <section className="relative mx-auto flex min-h-screen w-full max-w-2xl flex-col px-6 pb-32 pt-28">
        ...
        <section className="space-y-6">
          <div className="glass-panel rounded-[1.75rem] border-l-4 border-[rgb(255,178,185)] p-8">
            <h3 className="mb-3 text-xs font-black uppercase tracking-[0.22em] text-[rgb(255,178,185)]">
              {fin ? "Resultado final" : "¡Sigue intentando!"}
            </h3>
            <p className="text-sm font-medium leading-relaxed text-[var(--text-muted)]">
              {fin
                ? `Terminaste con ${aciertos} de ${total} respuestas correctas. ¡Intenta mejorar!`
                : "Esta no fue, pero la siguiente puede ser tuya. ¡Adelante!"}
            </p>
          </div>
